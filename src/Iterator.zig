...
pub const BlockIterator = struct {
    ...
    pub fn iterator(fba: std.mem.Allocator, db: Lmdb, last_hash: Hash) BlockIterator {
    ...
    pub fn next(self: *BlockIterator) ?Block {
        const txn = self.db.startTxn(.{ .rw = false }, BLOCK_DB);
    ...
    pub fn print(chain_iter: *BlockIterator) void {
